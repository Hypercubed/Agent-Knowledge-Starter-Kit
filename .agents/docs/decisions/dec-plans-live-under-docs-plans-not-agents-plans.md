---
id: dec-plans-live-under-docs-plans-not-agents-plans
title: "Maintainer plans live under `.agents/docs/plans/`, not `.agents/plans/`"
last_updated: 2026-04-22
description: >
  Canonical location for initiative and roadmap markdown is `.agents/docs/plans/`
...
depends_on:
  ...
  - dec-docs-search-remains-canonical-over-host-native-search
---
...
- **Search:** `index-docs.py` already picks up every markdown file under `.agents/docs/`; no special-case crawl is required.
...
- [Plans as first-class artifacts](../plans/plan-plans-as-first-class-artifacts.md)
