...
Outcome: updated Files: `.agents/docs/index.md`; `.agents/docs/MAINTENANCE.md`; `.agents/docs/troubleshooting/ts-github-copilot-chat-context-not-in-focus.md`; `README.md`; `.agents/skills/learning-distill/bootstrap/docs/index.md`; `.agents/skills/knowledge-lint/bootstrap/docs/index.md`; `example/.agents/docs/index.md`; `example/.agents/skills/learning-distill/bootstrap/docs/index.md`; `example/.agents/skills/knowledge-lint/bootstrap/docs/index.md`; `.agents/plans/plan-wiki-system.md`; `.agents/docs/log.md` Classification: drop “layout v2” framing and monolith migration narrative from normative docs; describe current directory layout only Disposition: accepted Notes: Older `log.md` rows may still mention layout v2 by name.
...
Outcome: updated\
Files: `README.md`; `INSTALL.md`; `.agents/plans/plan-consumer-upgrade-path.md`; `.agents/docs/log.md`\
...
Outcome: updated\
Files: `README.md`; `.agents/plans/plan-consumer-upgrade-path.md`; `.agents/docs/log.md`\
...
Outcome: updated\
Files: `.agents/docs/repo-decisions.md`; `.agents/docs/troubleshooting.md`; `.agents/docs/index.md`; `.agents/docs/log.md`; `.agents/playbooks/writing-integration-guides.md`; `.agents/plans/plan-add-integrations.md`; `README.md`; `docs/integrations/README.md`; `docs/integrations/hermes.md`; `.agents/sessions/20260412-003934-hermes-integration-review/summary.json`\
