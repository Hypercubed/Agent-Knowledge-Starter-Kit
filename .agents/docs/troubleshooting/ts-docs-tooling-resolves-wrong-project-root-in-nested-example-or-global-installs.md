---
id: ts-docs-tooling-resolves-wrong-project-root-in-nested-example-or-global-installs
title: "Docs tooling resolves wrong project root in nested `example/` or global installs"
last_updated: 2026-04-20
description: >
  Docs tooling may target the wrong project when scripts infer only git root;
  this entry describes override-first plus nearest-`.agents` resolution and checks.
