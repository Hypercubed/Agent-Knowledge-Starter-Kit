...
- After changing durable entry files, run `bash scripts/docs-compile.sh` to regenerate `decisions/index.md`, `troubleshooting/index.md`, and the maintainer **docs-search** cache (see [`.agents/playbooks/docs-compile.md`](../playbooks/docs-compile.md)) before **knowledge-lint** or publishing.
