...
description: 'Roadmap for per-tool integration guides under docs/integrations/ so adopters can wire this kit into their workflow; one guide remains (vscode-extensions.md).
...
Shared routing and comparison live in `docs/integrations/patterns.md` (linked from the index and README).
...
| `gemini-cli.md`        | Coding agent / CLI                      | `GEMINI.md`, `save_memory`, repo skills                                                          | How Gemini CLI bootstrap and memory tools relate to durable `.agents/` knowledge                                                                        | **done** — in tree; treat verification notes in guide as authoritative                                                                     |
| `warp.md`              | Terminal / agent product                | project and global rules, skills, Oz workflows                                                   | How Warp-native rules and skills should stay thin wiring over `.agents/`                                                                                | **done** — in tree; treat verification notes in guide as authoritative                                                                     |
