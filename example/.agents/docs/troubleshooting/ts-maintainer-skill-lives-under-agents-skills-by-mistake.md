---
id: ts-maintainer-skill-lives-under-agents-skills-by-mistake
...
- Add `metadata.internal: true` to the skill’s YAML frontmatter (see [`.agents/skills/generate-example/SKILL.md`](../../skills/generate-example/SKILL.md) and the repo decision [Maintainer-only skills use `metadata.internal: true`](../decisions/dec-maintainer-skills-mark-internal-in-frontmatter.md)), **or** remove the skill from the paths that ship to consumers per your publishing process.
