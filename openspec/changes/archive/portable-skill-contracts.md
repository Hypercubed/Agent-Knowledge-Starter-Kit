...
- [Use the routing pattern for agentic tool bootstrap files](../../../.agents/docs/decisions/use-the-routing-pattern-for-agentic-tool-bootstrap-files.md)
...
- A **Portable skill contracts** section in [`.agents/docs/MAINTENANCE.md`](../../../.agents/docs/MAINTENANCE.md) and the same section in [`.agents/skills/learning-distill/bootstrap/docs/MAINTENANCE.md`](../../../.agents/skills/learning-distill/bootstrap/docs/MAINTENANCE.md) (table of contract paths + precedence).
...
| Output                            | Destination                                                                                         |
| --------------------------------- | --------------------------------------------------------------------------------------------------- |
| Normative policy for all installs | [`.agents/docs/MAINTENANCE.md`](../../../.agents/docs/MAINTENANCE.md) and bootstrap twin under **learning-distill** |
