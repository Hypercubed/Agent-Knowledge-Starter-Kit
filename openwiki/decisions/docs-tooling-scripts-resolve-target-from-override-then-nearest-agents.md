...
description: 'Docs-search and docs-compile scripts should not assume git-root coupling;
...
Superseded — see [knowledge consolidation into OpenWiki](knowledge-consolidation-into-openwiki.md): the docs tooling scripts are retired
