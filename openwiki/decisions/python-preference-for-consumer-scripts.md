...
description: Consumer-facing scripts and tooling in the repository should be implemented
  in Python to ensure cross-platform compatibility and consistent development experience.
tags:
- scripts
- python
- maintenance
...
Superseded by [Single runtime - Node for kit scripts](node-single-runtime-for-kit-scripts.md)
